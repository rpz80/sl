...
public:
  ...
  virtual int64_t size() const override { return m_removed ? 0ll : kTestSize; }

  virtual bool exists() const override { return false; }
  virtual FileStreamPtr open() override { return FileStreamPtr(new TestFileStream); }
